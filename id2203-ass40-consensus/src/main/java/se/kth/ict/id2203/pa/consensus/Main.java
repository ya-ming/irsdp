...
//import se.kth.ict.id2203.components.paxos.Paxos;
//import se.kth.ict.id2203.components.paxos.PaxosInit;
...
import se.kth.ict.id2203.ports.ac.AcComponent;
import se.kth.ict.id2203.ports.ac.AcInit;
import se.kth.ict.id2203.ports.ac.AcPort;
...
public class Main extends ComponentDefinition {
	...
	public Main() {
		...
		Component ac = create(AcComponent.class, new AcInit(pi.size(), self.getId(), self));
		...
		connect(app.required(AcPort.class), ac.provided(AcPort.class));
