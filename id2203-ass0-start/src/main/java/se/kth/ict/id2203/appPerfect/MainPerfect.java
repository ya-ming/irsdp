...
public class MainPerfect extends ComponentDefinition {
	static {
	...
	public static void main(String[] args) {
		...
		Kompics.createAndStart(MainPerfect.class);
	}
	...
	public MainPerfect() {
		...
		Component pp2p = create(PerfectLink.class, new PerfectLinkInit(topology));
		...
		Component app = create(ApplicationPefect.class, new ApplicationPerfectInit(self, topology.getAllAddresses(), commandScript));
...
//		connect(app.required(FairLossPointToPointLink.class), flp2p.provided(FairLossPointToPointLink.class));
        ...
        connect(pp2p.required(StubbornPointToPointLink.class), sp2p.provided(StubbornPointToPointLink.class));
