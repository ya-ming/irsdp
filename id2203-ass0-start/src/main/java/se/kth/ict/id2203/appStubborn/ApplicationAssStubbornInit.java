...
public final class ApplicationAssStubbornInit extends Init<ApplicationAssStubborn> {

	private final Address selfAddress;
	private final Set<Address> allAddresses;
	private final String commandScript;

	public ApplicationAssStubbornInit(Address selfAddress, Set<Address> allAddresses, String commandScript) {
