...
public final class ApplicationAssFairLossInit extends Init<ApplicationAssFairLoss> {

	private final Address selfAddress;
	private final Set<Address> allAddresses;
	private final String commandScript;

	public ApplicationAssFairLossInit(Address selfAddress, Set<Address> allAddresses, String commandScript) {
