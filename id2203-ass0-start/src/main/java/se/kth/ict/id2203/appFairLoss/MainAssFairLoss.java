...
public class MainAssFairLoss extends ComponentDefinition {
	static {
	...
	public static void main(String[] args) {
		...
		Kompics.createAndStart(MainAssFairLoss.class);
	}

	public MainAssFairLoss() {
		...
		Component app = create(ApplicationAssFairLoss.class, new ApplicationAssFairLossInit(self, topology.getAllAddresses(), commandScript));
