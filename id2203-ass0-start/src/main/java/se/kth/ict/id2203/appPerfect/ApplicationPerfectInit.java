...
public final class ApplicationPerfectInit extends Init<ApplicationPefect> {

	private final Address selfAddress;
	private final Set<Address> allAddresses;
	private final String commandScript;

	public ApplicationPerfectInit(Address selfAddress, Set<Address> allAddresses, String commandScript) {
