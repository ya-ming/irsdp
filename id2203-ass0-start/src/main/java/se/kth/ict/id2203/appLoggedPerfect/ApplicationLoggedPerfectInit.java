...
public final class ApplicationLoggedPerfectInit extends Init<ApplicationLoggedPefect> {

	private final Address selfAddress;
	private final Set<Address> allAddresses;
	private final String commandScript;

	public ApplicationLoggedPerfectInit(Address selfAddress, Set<Address> allAddresses, String commandScript) {
