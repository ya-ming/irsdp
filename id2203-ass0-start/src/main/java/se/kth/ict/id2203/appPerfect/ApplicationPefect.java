...
public final class ApplicationPefect extends ComponentDefinition {

	private static final Logger logger = LoggerFactory.getLogger(ApplicationPefect.class);
	...
	public ApplicationPefect(ApplicationPerfectInit event) {
	...
	private Handler<ApplicationPerfectContinue> handleContinue = new Handler<ApplicationPerfectContinue>() {
		@Override
		public void handle(ApplicationPerfectContinue event) {
...
//	}
	...
	private void doSleep(long delay) {
		...
		st.setTimeoutEvent(new ApplicationPerfectContinue(st));
		trigger(st, timer);
