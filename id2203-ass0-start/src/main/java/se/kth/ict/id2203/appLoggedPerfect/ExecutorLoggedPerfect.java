...
public final class ExecutorLoggedPerfect {
...
//				 link(4, 2, 3000, 0.5);
		...
		Scenario scenario1 = new Scenario(MainLoggedPerfect.class) {
			{
		...
		Scenario scenario2 = new Scenario(MainLoggedPerfect.class) {
			{
        ...
        Scenario scenario3 = new Scenario(MainLoggedPerfect.class) {
            {
