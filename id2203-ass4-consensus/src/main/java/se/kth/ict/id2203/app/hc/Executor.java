		...
		Topology topology2 = new Topology() {
			{
				...
				// This matches Figure 5.2: Sample execution of hierarchical consensus
				// 1 propose 'w', 'w' reaches 4 only
				// 2, 3, detected crash of 1 and move to round 2
				// 2 propose 'x' overwrites 'w' at 4
				// 3 and 4 also decided 'x' on their rounds.
				link(1, 2, 10000, 0).bidirectional();
				link(1, 3, 10000, 0).bidirectional();
				link(1, 4, 500, 0).bidirectional();
