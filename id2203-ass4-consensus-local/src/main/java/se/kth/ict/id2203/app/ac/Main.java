 ...
 */
package se.kth.ict.id2203.app.ac;
...
public class Main extends ComponentDefinition {
	...
	public Main() {
		...
		Component ac = create(Paxos.class, new PaxosInit(self, pi));
		...
		connect(app.required(AbortableConsensus.class), ac.provided(AbortableConsensus.class));
