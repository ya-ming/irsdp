...
import se.kth.ict.id2203.ports.reconfigurable.rsc.ScDebug;
import se.kth.ict.id2203.ports.reconfigurable.rsc.ScDecide;
import se.kth.ict.id2203.ports.reconfigurable.rsc.ScPropose;
...
//			logger.info("Woke up from sleep");
	...
	private final void doHelp() {
		logger.info("Available commands: P<n>, S<n>, help, X");
	...
	private void doReconfiguration(String strings) {
		...
		StopSign stopSign = new StopSign(cfgId, newConfiguredAddress, cfgId);

		doPropose(stopSign, false);
	}
