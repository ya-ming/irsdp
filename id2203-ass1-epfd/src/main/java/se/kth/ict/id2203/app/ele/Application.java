...
public final class Application extends ComponentDefinition {
	...
	private Positive<EventualLeaderElectionPort> elep = requires(EventualLeaderElectionPort.class);
	...
	private Handler<Trust> handleTrust = new Handler<Trust>() {
		...
		public void handle(Trust event) {
			logger.info("Process {} Trust", event.getSource());
		}
	};
