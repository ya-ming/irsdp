...
public class ReadImposeWriteAllOneNInit extends Init<ReadImposeWriteAllOneN> {

	private final Address selfAddress;
	private final Set<Address> allAddresses;

	public ReadImposeWriteAllOneNInit(Address selfAddress, Set<Address> allAddresses) {
