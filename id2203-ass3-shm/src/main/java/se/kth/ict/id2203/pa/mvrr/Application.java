...
public final class Application extends ComponentDefinition {
	...
	private Positive<MajorityVotingRegularRegister> mvrr = requires(MajorityVotingRegularRegister.class);
	...
	public Application(ApplicationInit event) {
		...
		subscribe(handleReadResponse, mvrr);
		subscribe(handleWriteResponse, mvrr);
