package se.kth.ict.id2203.pa.mvrr;
...
import se.kth.ict.id2203.components.mvrr.MajorityVoting;
import se.kth.ict.id2203.components.mvrr.MajorityVotingInit;
...
public class Main extends ComponentDefinition {
	...
	public Main() {
		...
		Component register = create(MajorityVoting.class, new MajorityVotingInit(self, pi));
		...
		connect(app.required(MajorityVotingRegularRegister.class), register.provided(MajorityVotingRegularRegister.class));
