...
import se.kth.ict.id2203.components.riwaonar.ReadImposeWriteAllOneN;
import se.kth.ict.id2203.components.riwaonar.ReadImposeWriteAllOneNInit;
...
public class Main extends ComponentDefinition {
	...
	public Main() {
		...
		Component register = create(ReadImposeWriteAllOneN.class, new ReadImposeWriteAllOneNInit(self, pi));
		...
		connect(app.required(ReadImposeWriteAllOneNAtomicRegister.class), register.provided(ReadImposeWriteAllOneNAtomicRegister.class));
