...
public final class Application extends ComponentDefinition {
	...
	private Positive<ReadOneWriteAllOneNRegularRegister> rowaonrr = requires(ReadOneWriteAllOneNRegularRegister.class);
	...
	public Application(ApplicationInit event) {
		...
		subscribe(handleReadResponse, rowaonrr);
		subscribe(handleWriteResponse, rowaonrr);
