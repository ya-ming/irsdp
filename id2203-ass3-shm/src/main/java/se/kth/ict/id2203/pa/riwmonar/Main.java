...
public class Main extends ComponentDefinition {
	...
	public Main() {
		...
		Component register = create(ReadImposeWriteMajority.class, new ReadImposeWriteMajorityInit(self, pi));
		...
		connect(app.required(ReadImposeWriteMajorityOneNAtomicRegister.class), register.provided(ReadImposeWriteMajorityOneNAtomicRegister.class));
