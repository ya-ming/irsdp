...
public final class Application extends ComponentDefinition {
	...
	private Positive<ReadImposeWriteMajorityOneNAtomicRegister> riwmonar = requires(ReadImposeWriteMajorityOneNAtomicRegister.class);
	...
	public Application(ApplicationInit event) {
		...
		subscribe(handleReadResponse, riwmonar);
		subscribe(handleWriteResponse, riwmonar);
